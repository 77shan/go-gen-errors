...
import (
	...
	"github.com/77shan/go-gen-errors/cmd/protoc-gen-go-errors/v2/errors"
)

const (
	errorsPackage = protogen.GoImportPath("gitlab.wycx.com/ainas/zettos-photos/third_party/errors")
